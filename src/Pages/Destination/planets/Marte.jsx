    ...
    return(
            ...
            <div className="lg:flex lg:justify-around">
                <div className="lg:mt-28 md:mt-10 mt-[34px] text-white">
                    ...
                    <img src={ImgMars} alt="" className="lg:w-[445px] md:w-[300px] w-[170px] " />
                    </div>
                </div>
                <div className="lg:mt-52 md:mt-[53px] md:flex md:flex-col md:items-center mt-[26px] flex flex-col items-center">
                    ...
                    <div className="lg:mt-[37px] md:mt-8 mt-5">
                        <h1 className="font-belf lg:text-[100px] md:text-[80px] text-[56px] text-white">MARS</h1>
                    </div>
                    <div className="text-center">
                        <p className="text-lg text-[#D0D6F9]">Don’t forget to pack your hiking boots. You’ll need them to <br /> tackle Olympus Mons, the tallest planetary mountain in  <br /> 
                        our solar system. It’s two and a half times the size of <br /> Everest!</p>
                    </div>
